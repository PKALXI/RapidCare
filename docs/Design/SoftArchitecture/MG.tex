...
\item[Services:]Manages secure storage, retrieval, and updates of data related to healthcare networks, healthcare professionals, patient records, diagonsis prediction, and medicine prediction.
