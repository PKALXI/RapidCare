...
\subsubsection{Adminstrator Model Module (\mref{mAMM})} Gurleen

\begin{description}
\item[Secrets:] Represents the healthcare professional characteristics as a Data Structure.
\item[Services:] The UI and database are kept in sync via the data model, which acts as an intermediary. Any changes to healthcare professional's information made through the UI automatically update the database.
\item[Implemented By:] TypeScript, React
\item[Type of Module:] Abstract Object
\end{description}

\subsubsection{Patient Model Module (\mref{mPMM})} Gurleen

\begin{description}
\item[Secrets:] This model deals with sensitive information of patients that includes their personal details and other information.
\item[Services:] Provides functionality to manage patient's information.
\item[Implemented By:] TypeScript, React
\item[Type of Module:] Abstract Object
\end{description}
...
The user interfaces for the system are designed to provide an intuitive and efficient user experience for all stakeholders, including administrators and healthcare professionals. Below are the key interfaces:
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth,height=6cm]{healthcare_1.png}} 
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth,height=6cm]{healthcare_2.png}} 
