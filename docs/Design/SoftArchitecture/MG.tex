...
\subsubsection{Data Layer Module (\mref{mDLM})}

\begin{description}
\item[Secrets:]Database schema for indexing strategies, and data caching mechanisms for efficient storage and retrieval.
\item[Services:]Manages secure storage, retrieval, and updates of data related to healthcare networks, healthcare professionals, patient records, diagonsis predictions, and medicine predictions.
\item[Implemented By:]MongoDB, Node.js
\item[Type of Module:]Abstract Object
\end{description}
