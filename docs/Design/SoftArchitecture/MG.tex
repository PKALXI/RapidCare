...
\begin{description}
  ...
  \item [\refstepcounter{mnum} \mthemnum \label{mAPM}:] API Module
  ...
  \item [\refstepcounter{mnum} \mthemnum \label{mAMM}:] Account Management Module
  ...
  \item [\refstepcounter{mnum} \mthemnum \label{mDPM}:] Diagonsis Prediction Module
  \item [\refstepcounter{mnum} \mthemnum \label{mMPM}:] Medicicne Prediction Module
  \item [\refstepcounter{mnum} \mthemnum \label{mDLM}:] Data Layer Module
\end{description}
...
\midrule
\multirow{7}{0.3\textwidth}{Behaviour-Hiding Module} & M2 (\mref{mUAM})\\
& M3 (\mref{mAPM})\\
& M4 (\mref{mAVM})\\
& M5 (\mref{mCVM})\\
\midrule

\multirow{3}{0.3\textwidth}{Software Decision Module} & M1 (\mref{mAM})\\
& M6 (\mref{mAMM})\\
& M7 (\mref{mRGM})\\
& M8 (\mref{mTM})\\
& M9 (\mref{mDPM})\\
...
\subsubsection{Administrator View Module (\mref{mAVM})} Inreet
...
\subsubsection{Client View Module (\mref{mCVM})} Inreet
...
\subsubsection{Data Layer Module (\mref{mDLM})} Inreet
