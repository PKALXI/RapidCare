...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth,height=6cm]{admin.png}} % Replace with your actual image path
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth,height=6cm]{healthcare_1.png}} % Replace with your actual image path
    \caption{Healthcare Professional Interface - Login Screen}
    \label{fig:healthcare-interface-1}
\end{figure}

\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth,height=6cm]{healthcare_2.png}} % Replace with your actual image path
