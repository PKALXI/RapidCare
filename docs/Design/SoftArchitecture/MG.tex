...
\begin{description}
\item[Secrets:] This module requires access to information about different healthcare networks to function correctly.
\item[Services:] Provides functionality for administrators to manage permissions of different healthcare networks.
\item[Implemented By:] TypeScript, React
\item[Type of Module:] Abstract Object
\end{description}
