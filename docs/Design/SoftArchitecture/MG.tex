...
\begin{itemize}
  \item Week of Jan. 19th -- Rev0 Demonstration:
    \begin{itemize}
      \item Transcription optimization (Gurleen)
  ...
  \item Week of Jan. 26th
    \begin{itemize}
      ...
      \item Employee management + Patient Management (Inreet)
      \item Data Layer setup (Gurleen, Moamen)
    \end{itemize}
  ...
  \item Week of Mar. 16th
    \begin{itemize}
      \item AI assistant functionality.
