...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
Flask Application (Python) & Symptoms, Past medical History, User characteristics & Prediction of possible Diagnosis & InputDimError - Request data contained wrong typing or incorrect form attributes. \\
\hline
\end{tabular}
\end{center}
...
There will be no environment variables that this module with interact with.
...
\subsubsection{Exported Constants}
The exported constants for this module would a prediction of the possible medicine to treat the diagnosis.
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
Flask Application (Python) & Symptoms, Past medical History, User characteristics, Diagnosis & Prediction of possible Medicine & InputDimError - Request data contained wrong typing or incorrect form attributes. \\
\hline
\end{tabular}
\end{center}
