...
\item exception: N/A RenderError — thrown if the component fails to render.
\end{itemize}
...
\begin{itemize}
\item transition: Sends an API request to the API Module to process an add, delete, or update operation in the Administrator Account Management Database.
\item output: N/A
\item exception: InvalidInputError - The input data is incomplete or invalid.  

\noindent validateInput(InputData):
\begin{itemize}
\item transition: N/A
...
\section{MIS of Client View Module} \label{Module}
...
\begin{itemize}
\item transition: N/A
\item output: renders a react component of the client view page
\item exception: N/A RenderError — thrown if the component fails to render.
\end{itemize}
...
\begin{itemize}
\item transition: Sends an API request to the API Module to process an add, delete, or update operation in the Patient Account Management Database.
\item output: N/A
\item exception: InvalidInputError - The input data is incomplete or invalid.  
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
addHealthcareProfessional & id:string, value: FormData & - & InputDimError \\
deleteHealthcareProfessional & id:string & - & IdNotFound\\
updateHealthcareProfessional & id:string, value: FormData & - & InputDimError \\
\hline
\end{tabular}
\end{center}
...
\item output: N/A
\item exception: InputDimError - The input data is incomplete or invalid or a duplicate document already exists.
\end{itemize}
...
\item output: N/A
\item exception: InputDimError - The input data is incomplete or invalid.
\end{itemize}
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
createPatientRecord & id:string, value: FormData & - & InputDimError \\
deletePatientRecord & id:string & - & IdNotFound\\
updatePatientRecord & id:string, value: FormData & - & InputDimError \\
\hline
\end{tabular}
\end{center}
...
\section{MIS of Diagnosis Data Module} \label{diag_data}
...
\section{MIS of Medicine Data Module} \label{med_data}
\subsection{Module}
