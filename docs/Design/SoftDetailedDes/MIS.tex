...
& Broker Module\\
\midrule
\multirow{3}{0.3\textwidth}{Software Decision} & Administrator Model Module\\
...
\noindent login():
\begin{itemize}
\item transition: Change the state variable 'isUserAdmin' to true if the user is an adminstrator and false if the user is not an adminstrator.
\item output: N/A
\item exception: N/A
\end{itemize}
...
\begin{itemize}
\item transition: Sends a reset link to the provided email and rendes the login page.
\item output: N/A
