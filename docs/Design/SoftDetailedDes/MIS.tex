...
\noindent getter(): This is the getters will allow access to state variable while maintaining the information hiding principle.
\begin{itemize}
    \item transition: N/A
...
\noindent setter(): This is the getters will allow edit access to state variable while maintaining the information hiding principle.
\begin{itemize}
