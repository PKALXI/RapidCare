...
\section{MIS of API Module} \label{Module} Moamen
\wss{Use labels for cross-referencing}
...
\section{MIS of Diagnosis Data Module} \label{Module} Pranav
\wss{Use labels for cross-referencing}
...
\section{MIS of Medicine Data Module} \label{Module} Pranav
\wss{Use labels for cross-referencing}
