...
\section{MIS of UI - Administrator View} \label{Module} 
...
\section{MIS of UI - Client View} \label{Module} 
\wss{Use labels for cross-referencing}
...
\section{MIS of API Module (OAuth)} \label{Module} Moamen
\wss{Use labels for cross-referencing}
...
\section{MIS of User Authentication Module} \label{Module} Moamen
\wss{Use labels for cross-referencing}
...
\section{MIS of Account Management Module} \label{Module} Moamen
\wss{Use labels for cross-referencing}
...
\section{MIS of Daigonsis Prediction Module} \label{Module} Pranav
\wss{Use labels for cross-referencing}
...
\section{MIS of Medicine Prediction Module} \label{Module} Pranav
\wss{Use labels for cross-referencing}
