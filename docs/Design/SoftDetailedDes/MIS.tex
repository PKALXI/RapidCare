...
\section{MIS of Transcription Module} \label{Transription_Module}
...
\noindent TranscriptionModulemod(AudioData: Bytes): 
\begin{itemize}
  \item transition: N/A
  \item output: Written text transcribed from the audio stream. 
  \item exception: InvalidInputError - If the input audio could not be converted to bytes.   
\end{itemize}
