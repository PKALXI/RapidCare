...
\begin{longtable}{| p{0.1\textwidth} | p{0.4\textwidth} | p{0.3\textwidth} | p{0.1\textwidth} |}
    ...
    \hline
    Peer Review & Scope and Purpose of Hazard Analysis: API modules need more robust solutions.  &  Details of roboust solutions added. & \href{https://github.com/PKALXI/RapidCare/issues/104}{\#104} \\
    \hline
    Peer Review & FMEA table does not account for formatting issues in classification. & Potential hazard aadded in the table. & \href{https://github.com/PKALXI/RapidCare/issues/105}{\#105} \\
    \hline
    ...
    \hline
    Peer Review & Access requirements does not address how system will handle repeated failed login attempts. & Access requirements reworded to handle repeated login attempts. & \href{https://github.com/PKALXI/RapidCare/issues/107}{\#107} \\
    \hline
