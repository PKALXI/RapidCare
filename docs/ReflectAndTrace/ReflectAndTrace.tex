...
\begin{longtable}{| p{0.1\textwidth} | p{0.4\textwidth} | p{0.3\textwidth} | p{0.1\textwidth} |}
    ...
    \hline
    \endfoot
    Supervisor & Add functionality for uploading and creating prescriptions. & Created the functionality to create prescription. The feature was not fully developed as per feedback in Rev 0 demonstration to priortize more importants aspects of the project.  & \href{https://github.com/users/Inreet-Kaur/projects/6/views/2?pane=issue&itemId=97521959&issue=PKALXI%7CRapidCare%7C295}{\#295} \\
    \hline
    Supervisor & Add functionality for uploading and creating Referrals. & Created the functionality to create referrals. The feature was not fully developed as per feedback in Rev 0 demonstration to priortize more importants aspects of the project. & \href{https://github.com/users/Inreet-Kaur/projects/6/views/2?pane=issue&itemId=97521127&issue=PKALXI%7CRapidCare%7C294}{\#294} \\
    \hline
    ...
    \hline
    Usability Testing & Add disclaimers for predicitons. & Implement clear disclaimers when providing treatment plan and diagnoses predictions. & \href{https://github.com/users/Inreet-Kaur/projects/6/views/2?pane=issue&itemId=104780091&issue=PKALXI%7CRapidCare%7C426}{\#426} \\
    \hline
    Usability Testing, Peers & Add confirmation modals and appropriate feedback messages. & Implemented the confirmation modals and toast messages to give feedback to the user. & \href{https://github.com/users/Inreet-Kaur/projects/6/views/2?pane=issue&itemId=104780373&issue=PKALXI%7CRapidCare%7C427}{\#427} \\
    \hline
\end{longtable}
