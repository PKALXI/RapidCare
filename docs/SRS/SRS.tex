...
\item[NFR\refstepcounter{nfrnum}\thenfrnum \label{NFR_Maintainability}:] \textbf{Maintainability Requirement}
    ...
    \textbf{Constraint:} The system must encrypt all patient data using AES-256 encryption or an equivalent standard and comply with the Personal Information Protection and Electronic Documents Act (PIPEDA).

    \textbf{Rationale:} A secure and confidential system ensures the user is confident in using the application while protecting sensitive patient data from unauthorized access.
    
    \textbf{Verification:} Security audits will confirm full compliance with PIPEDA and adherence to encryption and data protection standards.
    
    \textbf{Dependencies:} N/A
    
    \textbf{Undesired Event Handling:} In the event of a security breach, all users will be logged out, access will be locked, and administrators will be alerted immediately.
...
\item[NFR\refstepcounter{nfrnum}\thenfrnum \label{NFR_Legal}:] \textbf{Legal Requirement}
    ...
    \textbf{Constraint:} The system must comply with the Personal Information Protection and Electronic Documents Act (PIPEDA).

    \textbf{Rationale:} Legal compliance is necessary to ensure patient data protection and to avoid potential legal penalties.
    
    \textbf{Verification:} Legal audits will confirm compliance with PIPEDA.
    
    \textbf{Dependencies:} N/A
    
    \textbf{Undesired Event Handling:} If the system fails to comply with regulations, it will be updated within 24 hours to meet compliance requirements.
