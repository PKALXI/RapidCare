...
const EditProfileInfo: React.FC<EditProfileInfoProps> = ({
  ...
  const [formData, setFormData] = useState({
    demographics: {
      ...
      healthcardNumber:
        patient.profileInformation?.demographics?.healthcardNumber || "",
    ...
    insuranceInformation: {
      memberID:
        patient.profileInformation?.insuranceInformation?.memberID || "",
      policyNumber:
        patient.profileInformation?.insuranceInformation?.policyNumber || "",
      provider:
        patient.profileInformation?.insuranceInformation?.provider || "",
    },
    emergencyContact: {
      name: patient.profileInformation?.emergencyContact?.name || "",
      relationship:
        patient.profileInformation?.emergencyContact?.relationship || "",
        ...
        if (patientData) {
          ...
          setFormData({
            demographics: {
              ...
              gender:
                patientData.profileInformation?.demographics?.gender || "",
              age: patientData.profileInformation?.demographics?.age || 0,
              dateOfBirth:
                patientData.profileInformation?.demographics?.dateOfBirth || "",
              healthcardNumber:
                patientData.profileInformation?.demographics
                  ?.healthcardNumber || "",
              weight:
                patientData.profileInformation?.demographics?.weight || "",
              height:
                patientData.profileInformation?.demographics?.height || "",
              maritalStatus:
                patientData.profileInformation?.demographics?.maritalStatus ||
                "",
              occupation:
                patientData.profileInformation?.demographics?.occupation || "",
            },
            contactInformation: {
              email:
                patientData.profileInformation?.contactInformation?.email || "",
              phone:
                patientData.profileInformation?.contactInformation?.phone || "",
              address:
                patientData.profileInformation?.contactInformation?.address ||
                "",
            },
            insuranceInformation: {
              memberID:
                patientData.profileInformation?.insuranceInformation
                  ?.memberID || "",
              policyNumber:
                patientData.profileInformation?.insuranceInformation
                  ?.policyNumber || "",
            ...
            emergencyContact: {
              name:
                patientData.profileInformation?.emergencyContact?.name || "",
              relationship:
                patientData.profileInformation?.emergencyContact
                  ?.relationship || "",
              phone:
                patientData.profileInformation?.emergencyContact?.phone || "",
              address:
                patientData.profileInformation?.emergencyContact?.address || "",
            },
          });
        }
      }
  ...
  return (
    <Dialog open={open} fullWidth>
              ...
              <Grid container spacing={4}>
                <Grid item xs={6} className="space-y-4">
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("demographics", "name", e.target.value)
                    }
                  />
                  <TextField
                    label="Gender"
                    ...
                    onChange={(e) =>
                      handleChange("demographics", "gender", e.target.value)
                    }
                  />
                  <TextField
                    label="Age"
                    ...
                    onChange={(e) =>
                      handleChange("demographics", "age", e.target.value)
                    }
                ...
                <Grid item xs={6} className="space-y-4">
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("demographics", "weight", e.target.value)
                    }
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("demographics", "height", e.target.value)
                    }
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      handleChange("demographics", "occupation", e.target.value)
                    }
                  />
                </Grid>
              </Grid>
      ...
      <div className="flex justify-center my-4">
        <Button variant="contained" color="primary" onClick={updateEntry}>
          Save
        </Button>
      </div>
    </Dialog>
